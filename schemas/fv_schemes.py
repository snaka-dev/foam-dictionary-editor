...
SCHEMAS: dict[str, KeySchema] = {
    "default.ddtSchemes": KeySchema(
        ...
        note=(
            "The representative values below are taken from Foundation v13 "
            "user-guide material. OpenCFD availability may differ by solver and release."
        ),
        choices=(
            ...
            ChoiceItem(
                "backward", "Second-order backward differencing scheme.", supported_in=(FOUNDATION_V13,)
            ),
            ChoiceItem(
                "CrankNicolson",
                "Blended second-order Crank-Nicolson scheme.",
                supported_in=(FOUNDATION_V13,),
            ),
    ...
    "default.gradSchemes": KeySchema(
        ...
        supported_in=(FOUNDATION_V13,),
        note=(
            "Foundation guide commonly presents Gauss-based gradient schemes "
            "with interpolation variants."
        ),
        choices=(
            ChoiceItem(
                "Gauss linear", "Gauss gradient with linear interpolation.", supported_in=(FOUNDATION_V13,)
            ),
            ChoiceItem(
                "leastSquares", "Least-squares gradient reconstruction.", supported_in=(FOUNDATION_V13,)
            ),
        ),
    ),
    "default.snGradSchemes": KeySchema(
        ...
        choices=(
            ...
            ChoiceItem(
                ...
                "Limited corrected form with limiter 0.33.",
                supported_in=(FOUNDATION_V13,),
            ),
            ChoiceItem(
                "limited corrected 0.5",
                "Limited corrected form with limiter 0.5.",
                supported_in=(FOUNDATION_V13,),
            ),
        ),
    ),
    ...
    "default.laplacianSchemes": KeySchema(
        ...
        supported_in=(FOUNDATION_V13,),
        note=(
            "Common forms combine Gauss linear with snGrad handling; "
            "exact syntax depends on the case entry."
        ),
        choices=(
            ChoiceItem(
                "Gauss linear corrected",
                "Gauss Laplacian with corrected snGrad handling.",
                supported_in=(FOUNDATION_V13,),
            ),
            ChoiceItem(
                "Gauss linear uncorrected",
                "Gauss Laplacian with uncorrected snGrad handling.",
                supported_in=(FOUNDATION_V13,),
            ),
            ChoiceItem(
                "Gauss linear limited corrected 0.33",
                "Gauss Laplacian with limited correction 0.33.",
                supported_in=(FOUNDATION_V13,),
            ),
            ChoiceItem(
                "Gauss linear limited corrected 0.5",
                "Gauss Laplacian with limited correction 0.5.",
                supported_in=(FOUNDATION_V13,),
            ),
        ),
    ),
