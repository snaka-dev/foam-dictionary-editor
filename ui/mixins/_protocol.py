...
class MainWindowProtocol(QMainWindow):
    ...
    # NOTE: these three have no return annotation on the real _UiOpsMixin
    # methods (so their bodies go unchecked there), but they do return a
    # QModelIndex — declaring that here (rather than copying a nonexistent
    # "-> None") is what lets *callers* in other mixins type-check correctly.
